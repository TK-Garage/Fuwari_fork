...
class ShortcutsPreferenceViewController: NSViewController {
    ...
    @IBOutlet private weak var ocrCaptureShortcutRecordView: RecordView! {
        didSet {
            ocrCaptureShortcutRecordView.tintColor = .main
        }
    }
    ...
    override func loadView() {
        ...
        ocrCaptureShortcutRecordView.delegate = self
        prepareHotKeys()
...
private extension ShortcutsPreferenceViewController {
    func prepareHotKeys() {
        ...
        ocrCaptureShortcutRecordView.keyCombo = HotKeyManager.shared.ocrCaptureKeyCombo
    }
}
...
extension ShortcutsPreferenceViewController: RecordViewDelegate {
    ...
    func recordViewDidClearShortcut(_ recordView: RecordView) {
        ...
        case ocrCaptureShortcutRecordView:
